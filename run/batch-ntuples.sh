...
if [ "$(basename ${pkg})" != "MuonRawHits" ]; then
    ...
    echo "       Please run from MuonRawHits/run/"
    echo
    return
fi
...
for run in 00278880 00279169 00279345 00279685 00280231 00280464 00280673 00280862 00281074 00281143 00281411 00282992 00283429 00283780 00284213 00284285 minbias; do
